package empleadoED_48607119T;

import java.util.*;
/**
 * Ejercicio práctico examen EVAL 1 ED
 * @author BERNAT PÉREZ DNI 48607119T
 * @version 1.0
 */


public class EmpleadoED_48607119T {
    ...
    public EmpleadoED_48607119T(String nombreCompleto, String dni) {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        EmpleadoED_48607119T emp = new EmpleadoED_48607119T("BERNAT PÉREZ", "48607119T");
        int horasExtra = 2;
